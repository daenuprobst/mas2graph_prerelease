...
from mas2graph.models import LightningMLPRegressor
...
def main(train_file: str, valid_file: str, test_file: str):
    ...
    dataset_train = train["binned_data"]
    dataset_valid = valid["binned_data"]
    dataset_test = test["binned_data"]
    ...
    model = LightningMLPRegressor(10000, 1024, learning_rate=0.00001)
